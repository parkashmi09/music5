...
import craft from "../../assets/song/feeling.png";
import arrow from "../../assets/create/arrow.png";

function Feelings({data}) {
  
  // Use the data from props if available, otherwise use default values
  const title = data?.title || "Turn Your Feelings into Unforgettable Lyrics";
