...
export default function TeamTrust1() {
  return (
    <div className="w-full py-0">
      <div className="flex justify-center items-center">
        <p className="lg:text-3xl font-bold text-white font-['Orbitron'] pt-10 ">
          Our trusted partners.
        </p>
      </div>

      {/* Logo slider container */}
      <div className="relative w-full overflow-hidden pt-3 pb-10">
